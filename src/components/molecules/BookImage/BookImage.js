  ...
  return (
    <StyledBookImage className={props.className}>
      <img
        ...
        src={
          book.bookCoverPhoto ? `http://localhost:8000/img/book-covers/${book.bookCoverPhoto}` : '/defaultCover.jpeg'
        }
        alt="book cover"
      />
      {updateSelected ? <FileInput handleImageSelection={handleImageSelection} file={file} setFile={setFile} /> : ''}
    </StyledBookImage>
  );
};
