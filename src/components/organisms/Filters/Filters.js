  ...
  return (
    <form className="filter-wrapper" onSubmit={onSubmit}>
      ...
      <div className="genre-filter">
        ...
        <LabeledCheckbox id="non-fiction" label="Non-fiction literature" name="non-fiction" {...register('genre.nonFiction')} />
        <LabeledCheckbox id="science" label="Scientific literature" name="scientific" {...register('genre.scientific')} />
